...
public final class MongoSession implements Session {
     ...
     * Area.
     *
     * <p>NOTE: This was originally stored in unicode format. Delomboking the code caused it to get converted to another
     * encoding, which isn't supported on all systems, so we migrated back to unicode. The same character is being
     * represented ensuring binary compatibility. See <a href=
