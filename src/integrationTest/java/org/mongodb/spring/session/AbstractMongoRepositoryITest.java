...
public abstract class AbstractMongoRepositoryITest extends AbstractITest {
    ...
    void saves() {
        ...
        Authentication toSaveToken = new UsernamePasswordAuthenticationToken(
    ...
    void loadExpiredSession() throws Exception {
        ...
        Instant thirtyOneMinutesAgo =
                Instant.ofEpochMilli(System.currentTimeMillis()).minus(Duration.ofMinutes(31));
